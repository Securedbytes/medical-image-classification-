...
- Place training images in `data/images_train/`
- Place validation images in `data/images_val/`
- Place test images in `data/images/`
- Download CSV files: `labels_train.csv`, `labels_val.csv`, `manifest_public.csv`
...
![SVM Confusion Matrix](results/svm/04_confusion_matrix.png)
![SVM ROC Curves](results/svm/05_roc_curves.png)
